...
var getAllFavoritesHelper = function(user) {
  return user.fetch({withRelated: ['favorites',
                                    'favorites.courseOfferings',
                                    'favorites.courseOfferings.meetings',
                                    'favorites.courseOfferings.term',
                                    'favorites.courseOfferings.professors']})
  .then(function(userData) {
    if (!userData) {
      throw new User.NotFoundError();
    }
    console.log(userData.related('favorites').models);
