    ...
    results.models.forEach(function(model, i) {
      ...
      .then(function(course) {
        ...
        .then(function(offering) {
          ...
          if (i === len - 1) {
            res.send(resultList);
            // console.log("This is result list in if");
        ...
        // console.log(resultList);
        //
        // console.log("This is result list now");
        // console.log(resultList);
  ...
  .then(function(results) {
    ...
    results.models.forEach(function(model, i) {
      ...
      .then(function(prof) {
        ...
        prof.related('courseOfferings').fetch({withRelated:['term','professors','schedules','requirements','meetings']})
        .then(function(offering){
          temp.courseOfferings = offering.toJSON();
          resultList.push(temp);
